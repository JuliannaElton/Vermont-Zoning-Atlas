...
|--------|------------|
|County| County the jurisdiction lies in|
|RPC| Regional Planning Comission Abbreviation the jurisdiction lies in|
...
|District Type| One of 4 options (Primarily Residential, Mixed with Residential, Nonresidential, Overlay, Overlay Not Affecting Use)|
...
|XF Min Unit Size| X is any number between 1-5; Min unit size in squre feet|
...
|Affordable Housing Min Unit Size| Affordable Housing min U=unit size in square feet|
